  ...
  <div class="dashboardMainContainer"> 
    ...
    <div class="dashboard_sidebar">
      ...
      <div class="dashboard_sidebar_user">
        ...
        <span>Oskar Bukol</span>
      </div>

      <div class="dashboard_sidebar_menu">
        <ul class="dashboard_menu_lists">
          <li><a href="dashboard.php?page=home"><i class="fa fa-home"></i> Dashboard</a></li>
        ...
        <div class="dashboard_content_main">
          <?php
            if ($page === 'home') {
                ...
                $allowed_pages = ['pending_residents', 'approved_residents', 'manage_residents', 'brgy', 'view_household'];
